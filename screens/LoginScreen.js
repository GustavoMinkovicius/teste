    ...
    isUserEqual = (googleUser, firebaseUser) => {
        if (firebaseUser) {
            ...
            for (var i = 0; i < providerData.length; i++) {
                if (providerData[i].providerId === firebase.default.auth.GoogleAuthProvider.PROVIDER_ID && providerData[i].uid === googleUser.getBasicProfile().getId()) {
    ...
    signInWithGoogleAsync = async() => {
        try {
            const result = await Google.logInAsync({
                behaviour: "web",
                androidClientId: "915981457109-1u9n14jnvot4en2sjgoojd459osv70nh.apps.googleusercontent.com",
                iosClientId: "915981457109-kv3kvca58i3jq39se97go4kia0tmnub3.apps.googleusercontent.com",
                ...
                <View style={styles.container}>
                    ...
                    <View style={styles.bottomContainer}>
                        <TouchableOpacity
                            ...
                            <Text style={styles.bottomText}>Login com o Google</Text>
                        </TouchableOpacity>
                    </View>
